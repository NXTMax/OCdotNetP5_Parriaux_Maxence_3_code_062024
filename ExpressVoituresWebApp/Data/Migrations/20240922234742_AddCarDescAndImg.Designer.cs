...
namespace ExpressVoituresWebApp.Data.Migrations
{
    ...
    [Migration("20240922234742_AddCarDescAndImg")]
    partial class AddCarDescAndImg
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpressVoituresWebApp.Data.Manufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpressVoituresWebApp.Data.Car", b =>
                {
                    b.HasOne("ExpressVoituresWebApp.Data.CarModel", "Model")
                        .WithMany()
            ...
            modelBuilder.Entity("ExpressVoituresWebApp.Data.CarRepair", b =>
                {
                    b.HasOne("ExpressVoituresWebApp.Data.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarVin")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExpressVoituresWebApp.Data.Repair", "Repair")
                        .WithMany()
